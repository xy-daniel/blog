...
<body>
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">管理 <small>标签管理</small></h1>
	<!-- end page-header -->
	<div class="panel panel-inverse">
		...
		<div class="panel-body">
			<div class="table-btn-row m-b-15">
				<g:link controller="tags" action="add" class="btn btn-sm btn-inverse btn-add"><i class="fa fa-plus m-r-5"></i> 添加标签</g:link>
				<sec:ifAllGranted roles='ROLE_SUPER'>
					<a href="javascript:void(0);" id="checkedBtn" class="btn btn-sm btn-inverse btn-del"><i class="fa fa-times m-r-5"></i> 删除标签</a>
				</sec:ifAllGranted>
			</div>
			<table id="data-table" class="table table-striped table-bordered display" style="width:100%">
				...
				<tr>
					...
					<th class="text-nowrap">标签名称</th>
					<th class="text-nowrap">标签下文章数目</th>
	...
	<asset:javascript src="console/tags/list.js"/>
	<!-- =========================END PAGE LEVEL JS======================== -->
</body>
</html>
