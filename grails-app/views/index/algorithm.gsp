...
<body>
  <!-- begin #header -->
	...
	<div id="page-title" class="page-title has-bg">
		<div class="bg-cover" data-paroller="true" data-paroller-factor="0.5" style="background: url(../assets/img/cover/cover-8.jpg) center 0px / cover no-repeat"></div>
		<div class="container">
			...
			<div class="post-list post-grid post-grid-3">
				...
				<div class="post-li">
					...
					<div class="post-content">
						...
						<div class="post-image">
							<a href="post_detail.gsp">
								<div class="post-image-cover" style="background-image: url(../assets/img/post/post-5.jpg)"></div>
							</a>
						</div>
						<!-- end post-image -->
						<!-- begin post-info -->
				...
				<div class="post-li">
					...
					<div class="post-content">
						...
						<div class="post-image">
							<a href="post_detail.gsp">
								<div class="post-image-cover" style="background-image: url(../assets/img/post/post-6.jpg)"></div>
							</a>
						</div>
						<!-- end post-image -->
						<!-- begin post-info -->
				...
				<div class="post-li">
					...
					<div class="post-content">
						...
						<div class="post-image">
							<a href="post_detail.gsp">
								<div class="post-image-cover" style="background-image: url(../assets/img/post/post-7.jpg)"></div>
							</a>
						</div>
						<!-- end post-image -->
						<!-- begin post-info -->
				...
				<div class="post-li">
					...
					<div class="post-content">
						...
						<div class="post-image">
							<a href="post_detail.gsp">
								<div class="post-image-cover" style="background-image: url(../assets/img/post/post-8.jpg)"></div>
							</a>
						</div>
						<!-- end post-image -->
						<!-- begin post-info -->
				...
				<div class="post-li">
					...
					<div class="post-content">
						...
						<div class="post-image">
							<a href="post_detail.gsp">
								<div class="post-image-cover" style="background-image: url(../assets/img/post/post-9.jpg)"></div>
							</a>
						</div>
						<!-- end post-image -->
						<!-- begin post-info -->
				...
				<div class="post-li">
					...
					<div class="post-content">
						...
						<div class="post-image">
							<a href="post_detail.gsp">
								<div class="post-image-cover" style="background-image: url(../assets/img/post/post-10.jpg)"></div>
							</a>
							<!-- end post-image -->
							<!-- begin post-info -->
							<div class="post-info">
