    ...
    $.fn.calendar = function (options) {
        ...
        this.each(function () {
            ...
            function showDaysOfMonth(month, year) {
                ...
                lblTextMonth.text(year + '年 ' + months[month]);
                lblTextMonth.attr("data-month",  month + 1);
                lblTextMonth.attr("data-year",  year);
                //days of month
                var day_counter = 1;
            ...
            function calculateWeekday(day, month, year) {
                ...
                //为了适应国内日历格式，这里获取到的numDay需要向前移一天
                if (numDay == 0) {
                    numDay = 6
                } else {
                    numDay--
            ...
            function markEvents(month, year) {
                ...
                for (var i = 0; i < events.length; i++) {
                    ...
                    if (events[i][0].split('/')[1] == t_month && events[i][0].split('/')[2] == year) {
                        ...
                        $('#' + calendar_id + '_' + events[i][0].replace(/\//g, "_") + ' a').attr('data-day', events[i][0]);
                        ...
                        if (events[i][2] == '' || events[i][2] == '#') {
                            if (events[i][4] != '') {
                                ...
                                $('#' + calendar_id + '_' + events[i][0].replace(/\//g, "_") + ' a').attr('href', 'javascript:void(0);');
                            }
                        } else {
